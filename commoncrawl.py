...
#Writing urls
csvFile = io.open('ccESPORTSlinks.csv', 'a', encoding="utf-8")
csvWriter = csv.writer(csvFile)
for url in ccESPORTS:
    csvWriter.writerow(''.join(url))
csvFile.close()

csvFile = io.open('ccNFLlinks.csv', 'a', encoding="utf-8")
csvWriter = csv.writer(csvFile)
for url in ccNFL:
    csvWriter.writerow(''.join(url))
csvFile.close()

csvFile = io.open('ccNHLlinks.csv', 'a', encoding="utf-8")
csvWriter = csv.writer(csvFile)
for url in ccNHL:
    csvWriter.writerow(''.join(url))
csvFile.close()

csvFile = io.open('ccNBAlinks.csv', 'a', encoding="utf-8")
csvWriter = csv.writer(csvFile)
for url in ccNBA:
    csvWriter.writerow(''.join(url))
csvFile.close()

csvFile = io.open('ccNCAAlinks.csv', 'a', encoding="utf-8")
csvWriter = csv.writer(csvFile)
for url in ccNCAA:
    csvWriter.writerow(''.join(url))
csvFile.close()
...
txtFile = open('ccESPORTSarticles.txt', 'a', encoding="utf-8")
...
txtFile = open('ccNFLarticles.txt', 'a', encoding="utf-8")
for link in ccNFL:
    try:
        article = NewsPlease.from_url(link)
        if article.text is not None:
...
txtFile = open('ccNHLarticles.txt', 'a', encoding="utf-8")
for link in ccNHL:
    try:
        article = NewsPlease.from_url(link)
        if article.text is not None:
...
txtFile = open('ccNCAAarticles.txt', 'a', encoding="utf-8")
for link in ccNCAA:
    try:
        article = NewsPlease.from_url(link)
        if article.text is not None:
...
txtFile = open('ccNBAarticles.txt', 'a', encoding="utf-8")
for link in ccNBA:
    try:
        article = NewsPlease.from_url(link)
        if article.text is not None:
